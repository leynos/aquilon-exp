...
class TestUpdateAddress(TestBrokerCommand):
    ...
    def test_100_update_reverse(self):
        ...
        ib_expect_update_address("arecord15.aqd-unittest.ms.com",
                                      "4.2.1.20",
    ...
    def test_130_update_dyndhcp_noop(self):
        ...
        ib_expect_update_address(fqdn, original_ip="10.25.0.21", reverse_ptr=fqdn)
    ...
    def test_140_restricted_reverse(self):
        ...
        ib_expect_update_address(fqdn, original_ip="4.2.1.37", reverse_ptr=reverse_ptr)
        command = ["update", "address",
                   "--fqdn", fqdn,
    ...
    def test145_alias_reverse(self):
        ib_expect_update_address("arecord17.aqd-unittest.ms.com",
                                      "4.2.1.37",
