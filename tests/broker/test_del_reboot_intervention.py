...
"""Module for testing the del reboot_intervention command."""
...
class TestDelRebootIntervention(TestBrokerCommand):

    def test_100_del_reboot_intervention(self):
