...
class TestAddAddressAlias(TestBrokerCommand):
    ...
    def test_101_add_addralias(self):
        ib_expect_add_a("addralias1.aqd-unittest.ms.com", "4.2.1.18", justification=self.just_sn)
        command = ["add", "address", "alias",
                   "--fqdn", "addralias1.aqd-unittest.ms.com",
                   "--target", "arecord13.aqd-unittest.ms.com"] \
                  + self.valid_just_sn
    ...
    def test_200_add_new_addralias_with_comment_and_ttl(self):
        ib_expect_add_a("addralias1.aqd-unittest.ms.com", "4.2.1.19", ttl=1800, justification=self.just_sn)
        command = ["add", "address", "alias",
                   "--fqdn", "addralias1.aqd-unittest.ms.com",
    ...
    def test_200_add_new_addralias_with_comment2(self):
        ib_expect_add_a("addralias1.aqd-unittest.ms.com", "4.2.1.20", justification=self.just_sn)
        command = ["add", "address", "alias",
                   "--fqdn", "addralias1.aqd-unittest.ms.com",
    ...
    def test_800_grn(self):
        ib_expect_add_a("addralias3.aqd-unittest.ms.com", "4.2.1.18", justification=self.just_sn)
        command = ["add", "address", "alias",
    ...
    def test_810_implicit_grn(self):
        ib_expect_add_a("addralias3.aqd-unittest.ms.com", "4.2.1.19", justification=self.just_sn)
        command = ["add", "address", "alias",
                   "--fqdn", "addralias3.aqd-unittest.ms.com",
                   "--target", "arecord14.aqd-unittest.ms.com"] \
                  + self.valid_just_sn
    ...
    def test_820_eon_id(self):
        ib_expect_add_a("addralias4.aqd-unittest.ms.com", "4.2.1.18", justification=self.just_sn)
        command = ["add", "address", "alias",
    ...
    def test_900_ib_address_alias(self):
        ...
        for dns_environment in ['internal', 'external']:
            ...
            if dns_environment == 'internal':
                ib_expect_add_a("address-alias-fqdn.test-infoblox.cc", "10.25.0.1",
            ...
            command = ['del_address_alias',
                       ...
                       '--dns_environment', dns_environment] + self.valid_just_tcm
            if dns_environment == 'internal':
                ib_expect_del_a("address-alias-fqdn.test-infoblox.cc", "10.25.0.1",
                                justification=self.valid_justification, fail=True)
                self.iberrortest(command)
                ib_expect_del_a("address-alias-fqdn.test-infoblox.cc", "10.25.0.1",
                                justification=self.valid_justification)
