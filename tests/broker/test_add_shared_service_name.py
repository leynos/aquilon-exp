...
class TestAddSharedServiceName(TestBrokerCommand):
    ...
    def test_030_pn_dns_sa(self):
        ib_expect_add_a("utvcs1pn1.aqd-unittest.ms.com", "4.2.1.18", justification=self.just_sn)
    ...
    def test_035_pn_dns_sa_remove(self):
        ib_expect_del_a("utvcs1pn1.aqd-unittest.ms.com", "4.2.1.18", justification=self.just_sn)
